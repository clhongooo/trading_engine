...
class SystemConfig : boost::noncopyable
{
  public:
    ...
    bool                   B2_HasEnabledRotationMode(const StrategyID)                         const;
  ...
  private:
    ...
    bool                                               m_B2_US_HasEnabledMinCommissionCheck;
    bool                                               m_B2_US_HasEnabledRotationMode;
    string                                             m_B2_US_TheoCPnLHistFolder;
