...
class SystemConfig : boost::noncopyable
{
  ...
  private:
    ...
    bool                                               m_B2_USSTK_HasEnabledMinCommissionCheck;
    int                                                m_B2_USSTK_HasEnabledRotationMode;
    string                                             m_B2_USSTK_TheoCPnLHistFolder;
    string                                             m_B2_USSTK_TheoPosFolder;
    bool                                               m_B2_USSTK_PersistTheoPosCPnL;
    vector<int>                                        m_B2_USSTK_RotationGroup;
    int                                                m_B2_USSTK_ChooseBestNRotationGroup;
    int                                                m_B2_USSTK_ActionTimeBefCloseInSec;
    vector<int>                                        m_B2_USSTK_FilterSMAPeriod;
    bool                                               m_B2_USSTK_MoveNextBestUpIfNoSignal;
    bool                                               m_B2_USSHT_HasEnabledMinCommissionCheck;
    int                                                m_B2_USSHT_HasEnabledRotationMode;
    string                                             m_B2_USSHT_TheoCPnLHistFolder;
    string                                             m_B2_USSHT_TheoPosFolder;
    bool                                               m_B2_USSHT_PersistTheoPosCPnL;
    vector<int>                                        m_B2_USSHT_RotationGroup;
    int                                                m_B2_USSHT_ChooseBestNRotationGroup;
    int                                                m_B2_USSHT_ActionTimeBefCloseInSec;
    vector<int>                                        m_B2_USSHT_FilterSMAPeriod;
    bool                                               m_B2_USSHT_MoveNextBestUpIfNoSignal;
