...
const char * FSMC2::Name() { return "fsmc2"; }
FSMC2::FSMC2()
{
...
void FSMC2::Add(double dH, double dL, double dC, double dVHSI)
{
	_dH = dH;
	_dL = dL;
	_dC = dC;
...
int FSMC2::TotalStates() { return 64; }
int FSMC2::State()
{
	if (!Ready())
	{
...
string FSMC2::StateDesc(int iState)
{
