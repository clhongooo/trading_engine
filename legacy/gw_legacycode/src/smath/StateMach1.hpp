...
bool StateMach1::WarmedUp() const
{
	bool bWU = true;
	if (bWU && !_sma1.WarmedUp()) bWU = false;
	if (bWU && !_sma2.WarmedUp()) bWU = false;
	if (bWU && !_sma3.WarmedUp()) bWU = false;
	if (bWU && !_wr1.WarmedUp()) bWU = false;
