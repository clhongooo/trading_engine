...
void SystemConfig::ReadConfig(const string & sConfigPath)
{
  ...
  bool bEnableWriteMutex = pt.get<bool>("SystemSettings.EnableLogMutex");
  m_Logger->SetEnableWriteMutex(bEnableWriteMutex);
...
void SystemConfig::ReadConfigOptional(const string & sConfigPath)
{
  ...
  boost::optional<bool> oEnableLogMutex = pt.get_optional<bool>("SystemSettings.EnableLogMutex");
  if (oEnableLogMutex)
  {
    m_Logger->SetEnableWriteMutex(oEnableLogMutex.get());
  }
