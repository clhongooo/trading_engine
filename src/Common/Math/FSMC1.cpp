...
const char * FSMC1::Name() { return "swv"; }
FSMC1::FSMC1()
{
	//20130207
...
void FSMC1::Add(double dH, double dL, double dC, double dVHSI)
{
	_dH = dH;
	_dL = dL;
	_dC = dC;
...
int FSMC1::TotalStates() { return 64; }
int FSMC1::State()
{
	if (!Ready())
	{
...
string FSMC1::StateDesc(int iState)
{
