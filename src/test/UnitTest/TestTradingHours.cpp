...
{
  {
    ...
    for (unsigned int iTestCase = 0; iTestCase < 3; ++iTestCase)
    {
      ...
      CPPUNIT_ASSERT(!th.IsTradingHour("HSIF5",YYYYMMDD(20150113),HHMMSS(125959)));
  ...
  }
  {
    ...
    CPPUNIT_ASSERT(th.GetTimeNSecAftOpen("HSI",YYYYMMDD(20150418),300) == HHMMSS(93500));
    CPPUNIT_ASSERT(th.GetTimeNSecAftOpen("HSI",YYYYMMDD(20250418),300) == HHMMSS(93500));
    CPPUNIT_ASSERT(th.GetTimeNSecAftOpen("HSI",YYYYMMDD(19000101),300) == HHMMSS());

    CPPUNIT_ASSERT(th.GetTimeNSecAftOpen("BOGUS",YYYYMMDD(20150418),300) == HHMMSS(100500));
    CPPUNIT_ASSERT(th.GetTimeNSecAftOpen("BOGUSUS",YYYYMMDD(20150418),300) == HHMMSS(93500));
    CPPUNIT_ASSERT(th.GetTimeNSecAftOpen("BOGUS2",YYYYMMDD(20150418),300) == HHMMSS());
  }
}
