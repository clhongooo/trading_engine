...
// for omd_mdi
//--------------------------------------------------
void OrderBook::Dump(ATU_MDI_marketfeed_struct &s) const
{
  char sPrice[256];
...

  {
    ...
    int i = _BIDQstart;
    int iPriceLevel = 1;
    while (i != _BIDQend && iPriceLevel <= 5)
    {
      switch (iPriceLevel)
      {
        case 1:  { s.m_bid_price_1 = (double) (*_BIDQ)[i].Price / 1000; ; s.m_bid_volume_1 = (*_BIDQ)[i].AggQty; break; }
        case 2:  { s.m_bid_price_2 = (double) (*_BIDQ)[i].Price / 1000; ; s.m_bid_volume_2 = (*_BIDQ)[i].AggQty; break; }
        case 3:  { s.m_bid_price_3 = (double) (*_BIDQ)[i].Price / 1000; ; s.m_bid_volume_3 = (*_BIDQ)[i].AggQty; break; }
        case 4:  { s.m_bid_price_4 = (double) (*_BIDQ)[i].Price / 1000; ; s.m_bid_volume_4 = (*_BIDQ)[i].AggQty; break; }
        case 5:  { s.m_bid_price_5 = (double) (*_BIDQ)[i].Price / 1000; ; s.m_bid_volume_5 = (*_BIDQ)[i].AggQty; break; }
        default: {                                                                                               break; }
      }
      i = Bounded(i+1);
      iPriceLevel++;
    ...
    while (iPriceLevel <= 5)
    {
      switch (iPriceLevel)
      {
        case 1:  { s.m_bid_price_1 = INVALID_PRICE; s.m_bid_volume_1 = 0; break; }
        case 2:  { s.m_bid_price_2 = INVALID_PRICE; s.m_bid_volume_2 = 0; break; }
        case 3:  { s.m_bid_price_3 = INVALID_PRICE; s.m_bid_volume_3 = 0; break; }
        case 4:  { s.m_bid_price_4 = INVALID_PRICE; s.m_bid_volume_4 = 0; break; }
        case 5:  { s.m_bid_price_5 = INVALID_PRICE; s.m_bid_volume_5 = 0; break; }
        default: {                                                        break; }
      }
      iPriceLevel++;
    }
...

  {
    ...
    int i = _ASKQstart;
    int iPriceLevel = 1;
    while (i != _ASKQend && iPriceLevel <= 5)
    {
      switch (iPriceLevel)
      {
        case 1:  { s.m_ask_price_1 = (double) (*_ASKQ)[i].Price / 1000; s.m_ask_volume_1 = (*_ASKQ)[i].AggQty; break; }
        case 2:  { s.m_ask_price_2 = (double) (*_ASKQ)[i].Price / 1000; s.m_ask_volume_2 = (*_ASKQ)[i].AggQty; break; }
        case 3:  { s.m_ask_price_3 = (double) (*_ASKQ)[i].Price / 1000; s.m_ask_volume_3 = (*_ASKQ)[i].AggQty; break; }
        case 4:  { s.m_ask_price_4 = (double) (*_ASKQ)[i].Price / 1000; s.m_ask_volume_4 = (*_ASKQ)[i].AggQty; break; }
        case 5:  { s.m_ask_price_5 = (double) (*_ASKQ)[i].Price / 1000; s.m_ask_volume_5 = (*_ASKQ)[i].AggQty; break; }
        default: {                                                                                             break; }
      }
      i = Bounded(i+1);
      iPriceLevel++;
    ...
    while (iPriceLevel <= 5)
    {
      switch (iPriceLevel)
      {
        case 1:  { s.m_ask_price_1 = INVALID_PRICE; s.m_ask_volume_1 = 0; break; }
        case 2:  { s.m_ask_price_2 = INVALID_PRICE; s.m_ask_volume_2 = 0; break; }
        case 3:  { s.m_ask_price_3 = INVALID_PRICE; s.m_ask_volume_3 = 0; break; }
        case 4:  { s.m_ask_price_4 = INVALID_PRICE; s.m_ask_volume_4 = 0; break; }
        case 5:  { s.m_ask_price_5 = INVALID_PRICE; s.m_ask_volume_5 = 0; break; }
        default: {                                                        break; }
      }
      iPriceLevel++;
    }
