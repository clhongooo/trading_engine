...
public:
        ...
        static const std::uint16_t mDEntrySizeId(void)
        {
            return 271;
        }

        static const std::uint64_t mDEntrySizeSinceVersion(void)
        {
             return 0;
        }
        ...
        {
            return (m_actingVersion >= mDEntrySizeSinceVersion()) ? true : false;
        }
        ...
        static const std::int32_t mDEntrySizeNullValue()
        {
            return SBE_NULLVALUE_INT32;
        }

        static const std::int32_t mDEntrySizeMinValue()
        {
            return -2147483647;
        }

        static const std::int32_t mDEntrySizeMaxValue()
        {
            return 2147483647;
        }
        ...
        static const std::uint16_t numberOfOrdersId(void)
        {
            return 346;
        }

        static const std::uint64_t numberOfOrdersSinceVersion(void)
        {
             return 0;
        }
        ...
        {
            return (m_actingVersion >= numberOfOrdersSinceVersion()) ? true : false;
        }
        ...
        static const std::int32_t numberOfOrdersNullValue()
        {
            return 2147483647;
        }

        static const std::int32_t numberOfOrdersMinValue()
        {
            return -2147483647;
        }

        static const std::int32_t numberOfOrdersMaxValue()
        {
            return 2147483647;
        }
        ...
        static const std::uint16_t aggressorSideId(void)
        {
            return 5797;
        }

        static const std::uint64_t aggressorSideSinceVersion(void)
        {
             return 0;
        }
        ...
        {
            return (m_actingVersion >= aggressorSideSinceVersion()) ? true : false;
        }
...
public:
    ...
    public:
        ...
        static const std::uint16_t orderIDId(void)
        {
            return 37;
        }

        static const std::uint64_t orderIDSinceVersion(void)
        {
             return 0;
        }
        ...
        {
            return (m_actingVersion >= orderIDSinceVersion()) ? true : false;
        }
        ...
        static const std::uint64_t orderIDNullValue()
        {
            return SBE_NULLVALUE_UINT64;
        }

        static const std::uint64_t orderIDMinValue()
        {
            return 0x0L;
        }

        static const std::uint64_t orderIDMaxValue()
        {
            return 0xfffffffffffffffeL;
        }
        ...
        static const std::uint16_t lastQtyId(void)
        {
            return 32;
        }

        static const std::uint64_t lastQtySinceVersion(void)
        {
             return 0;
        }
        ...
        {
            return (m_actingVersion >= lastQtySinceVersion()) ? true : false;
        }
        ...
        static const std::int32_t lastQtyNullValue()
        {
            return SBE_NULLVALUE_INT32;
        }

        static const std::int32_t lastQtyMinValue()
        {
            return -2147483647;
        }

        static const std::int32_t lastQtyMaxValue()
        {
            return 2147483647;
        }
...
public:
    ...
    static const std::uint16_t NoOrderIDEntriesId(void)
    {
        return 37705;
    }
