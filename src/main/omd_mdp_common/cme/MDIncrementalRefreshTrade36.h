...
public:
        ...
        static const std::uint16_t tradeIDId(void)
        {
            return 1003;
        }

        static const std::uint64_t tradeIDSinceVersion(void)
        {
             return 0;
        }
        ...
        {
            return (m_actingVersion >= tradeIDSinceVersion()) ? true : false;
        }
        ...
        static const std::int32_t tradeIDNullValue()
        {
            return SBE_NULLVALUE_INT32;
        }

        static const std::int32_t tradeIDMinValue()
        {
            return -2147483647;
        }

        static const std::int32_t tradeIDMaxValue()
        {
            return 2147483647;
        }
