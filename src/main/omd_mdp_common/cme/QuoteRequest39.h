...
public:
    ...
    static const std::uint16_t quoteReqIDId(void)
    {
        return 131;
    }

    static const std::uint64_t quoteReqIDSinceVersion(void)
    {
         return 0;
    }
    ...
    {
        return (m_actingVersion >= quoteReqIDSinceVersion()) ? true : false;
    }
    ...
    static const char quoteReqIDNullValue()
    {
        return (char)0;
    }

    static const char quoteReqIDMinValue()
    {
        return (char)32;
    }

    static const char quoteReqIDMaxValue()
    {
        return (char)126;
    }

    static const std::uint64_t quoteReqIDLength(void)
    {
        return 23;
    }
...
public:
    ...
    public:
        ...
        static const std::uint16_t orderQtyId(void)
        {
            return 38;
        }

        static const std::uint64_t orderQtySinceVersion(void)
        {
             return 0;
        }
        ...
        {
            return (m_actingVersion >= orderQtySinceVersion()) ? true : false;
        }
        ...
        static const std::int32_t orderQtyNullValue()
        {
            return 2147483647;
        }

        static const std::int32_t orderQtyMinValue()
        {
            return -2147483647;
        }

        static const std::int32_t orderQtyMaxValue()
        {
            return 2147483647;
        }
        ...
        static const std::uint16_t quoteTypeId(void)
        {
            return 537;
        }

        static const std::uint64_t quoteTypeSinceVersion(void)
        {
             return 0;
        }
        ...
        {
            return (m_actingVersion >= quoteTypeSinceVersion()) ? true : false;
        }
        ...
        static const std::int8_t quoteTypeNullValue()
        {
            return SBE_NULLVALUE_INT8;
        }

        static const std::int8_t quoteTypeMinValue()
        {
            return (std::int8_t)-127;
        }

        static const std::int8_t quoteTypeMaxValue()
        {
            return (std::int8_t)127;
        }
        ...
        static const std::uint16_t sideId(void)
        {
            return 54;
        }

        static const std::uint64_t sideSinceVersion(void)
        {
             return 0;
        }
        ...
        {
            return (m_actingVersion >= sideSinceVersion()) ? true : false;
        }
        ...
        static const std::int8_t sideNullValue()
        {
            return (std::int8_t)127;
        }

        static const std::int8_t sideMinValue()
        {
            return (std::int8_t)-127;
        }

        static const std::int8_t sideMaxValue()
        {
            return (std::int8_t)127;
        }
...
public:
    ...
    static const std::uint16_t NoRelatedSymId(void)
    {
        return 146;
    }
