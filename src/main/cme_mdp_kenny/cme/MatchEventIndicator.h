...
public:
    ...
    {
        return ((*((std::uint8_t *)(m_buffer + m_offset))) & (0x1L << 3)) ? true : false;
    }
    ...
    {
        return ((*((std::uint8_t *)(m_buffer + m_offset))) & (0x1L << 4)) ? true : false;
    }
    ...
    {
        return ((*((std::uint8_t *)(m_buffer + m_offset))) & (0x1L << 5)) ? true : false;
    }
    ...
    {
        return ((*((std::uint8_t *)(m_buffer + m_offset))) & (0x1L << 6)) ? true : false;
    }
    ...
    {
        return ((*((std::uint8_t *)(m_buffer + m_offset))) & (0x1L << 7)) ? true : false;
    }
