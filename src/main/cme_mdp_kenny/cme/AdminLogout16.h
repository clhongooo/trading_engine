...
public:
    ...
    static const std::uint16_t textId(void)
    {
        return 58;
    }

    static const std::uint64_t textSinceVersion(void)
    {
         return 0;
    }
    ...
    {
        return (m_actingVersion >= textSinceVersion()) ? true : false;
    }
    ...
    static const char textNullValue()
    {
        return (char)0;
    }

    static const char textMinValue()
    {
        return (char)32;
    }

    static const char textMaxValue()
    {
        return (char)126;
    }

    static const std::uint64_t textLength(void)
    {
        return 180;
    }
