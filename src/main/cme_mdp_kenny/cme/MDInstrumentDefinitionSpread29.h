...
public:
    ...
    static const std::uint16_t securitySubTypeId(void)
    {
        return 762;
    }

    static const std::uint64_t securitySubTypeSinceVersion(void)
    {
         return 0;
    }
    ...
    {
        return (m_actingVersion >= securitySubTypeSinceVersion()) ? true : false;
    }
    ...
    static const char securitySubTypeNullValue()
    {
        return (char)0;
    }

    static const char securitySubTypeMinValue()
    {
        return (char)32;
    }

    static const char securitySubTypeMaxValue()
    {
        return (char)126;
    }

    static const std::uint64_t securitySubTypeLength(void)
    {
        return 5;
    }
...
public:
    ...
    static const std::uint16_t priceRatioId(void)
    {
        return 5770;
    }

    static const std::uint64_t priceRatioSinceVersion(void)
    {
         return 0;
    }
    ...
    {
        return (m_actingVersion >= priceRatioSinceVersion()) ? true : false;
    }
...
public:
    ...
    public:
        ...
        static const std::uint16_t legSecurityIDId(void)
        {
            return 602;
        }

        static const std::uint64_t legSecurityIDSinceVersion(void)
        {
             return 0;
        }
        ...
        {
            return (m_actingVersion >= legSecurityIDSinceVersion()) ? true : false;
        }
        ...
        static const std::int32_t legSecurityIDNullValue()
        {
            return SBE_NULLVALUE_INT32;
        }

        static const std::int32_t legSecurityIDMinValue()
        {
            return -2147483647;
        }

        static const std::int32_t legSecurityIDMaxValue()
        {
            return 2147483647;
        }
        ...
        static const std::uint16_t legSecurityIDSourceId(void)
        {
            return 603;
        }

        static const std::uint64_t legSecurityIDSourceSinceVersion(void)
        {
             return 0;
        }
        ...
        {
            return (m_actingVersion >= legSecurityIDSourceSinceVersion()) ? true : false;
        }
        ...
        static const char legSecurityIDSourceNullValue()
        {
            return (char)0;
        }

        static const char legSecurityIDSourceMinValue()
        {
            return (char)32;
        }

        static const char legSecurityIDSourceMaxValue()
        {
            return (char)126;
        }

        static const std::uint64_t legSecurityIDSourceLength(void)
        {
            return 1;
        }
        ...
        static const std::uint16_t legSideId(void)
        {
            return 624;
        }

        static const std::uint64_t legSideSinceVersion(void)
        {
             return 0;
        }
        ...
        {
            return (m_actingVersion >= legSideSinceVersion()) ? true : false;
        }
        ...
        static const std::uint16_t legRatioQtyId(void)
        {
            return 623;
        }

        static const std::uint64_t legRatioQtySinceVersion(void)
        {
             return 0;
        }
        ...
        {
            return (m_actingVersion >= legRatioQtySinceVersion()) ? true : false;
        }
        ...
        static const std::int8_t legRatioQtyNullValue()
        {
            return SBE_NULLVALUE_INT8;
        }

        static const std::int8_t legRatioQtyMinValue()
        {
            return (std::int8_t)-127;
        }

        static const std::int8_t legRatioQtyMaxValue()
        {
            return (std::int8_t)127;
        }
        ...
        static const std::uint16_t legPriceId(void)
        {
            return 566;
        }

        static const std::uint64_t legPriceSinceVersion(void)
        {
             return 0;
        }
        ...
        {
            return (m_actingVersion >= legPriceSinceVersion()) ? true : false;
        }
...
public:
        ...
        static const std::uint16_t legOptionDeltaId(void)
        {
            return 1017;
        }

        static const std::uint64_t legOptionDeltaSinceVersion(void)
        {
             return 0;
        }
        ...
        {
            return (m_actingVersion >= legOptionDeltaSinceVersion()) ? true : false;
        }
...
public:
    ...
    static const std::uint16_t NoLegsId(void)
    {
        return 555;
    }
