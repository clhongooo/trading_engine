...
public:
    ...
    static const std::uint16_t lastMsgSeqNumProcessedId(void)
    {
        return 369;
    }

    static const std::uint64_t lastMsgSeqNumProcessedSinceVersion(void)
    {
         return 0;
    }
    ...
    {
        return (m_actingVersion >= lastMsgSeqNumProcessedSinceVersion()) ? true : false;
    }
    ...
    static const std::uint32_t lastMsgSeqNumProcessedNullValue()
    {
        return SBE_NULLVALUE_UINT32;
    }

    static const std::uint32_t lastMsgSeqNumProcessedMinValue()
    {
        return 0;
    }

    static const std::uint32_t lastMsgSeqNumProcessedMaxValue()
    {
        return 4294967293;
    }
...
public:
        ...
        static const std::uint16_t mDPriceLevelId(void)
        {
            return 1023;
        }

        static const std::uint64_t mDPriceLevelSinceVersion(void)
        {
             return 0;
        }
        ...
        {
            return (m_actingVersion >= mDPriceLevelSinceVersion()) ? true : false;
        }
        ...
        static const std::int8_t mDPriceLevelNullValue()
        {
            return (std::int8_t)127;
        }

        static const std::int8_t mDPriceLevelMinValue()
        {
            return (std::int8_t)-127;
        }

        static const std::int8_t mDPriceLevelMaxValue()
        {
            return (std::int8_t)127;
        }
