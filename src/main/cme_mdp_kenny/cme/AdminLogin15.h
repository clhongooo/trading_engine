...
public:
    ...
    static const std::uint16_t heartBtIntId(void)
    {
        return 108;
    }

    static const std::uint64_t heartBtIntSinceVersion(void)
    {
         return 0;
    }
    ...
    {
        return (m_actingVersion >= heartBtIntSinceVersion()) ? true : false;
    }
    ...
    static const std::int8_t heartBtIntNullValue()
    {
        return SBE_NULLVALUE_INT8;
    }

    static const std::int8_t heartBtIntMinValue()
    {
        return (std::int8_t)-127;
    }

    static const std::int8_t heartBtIntMaxValue()
    {
        return (std::int8_t)127;
    }
